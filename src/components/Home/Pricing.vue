...
<body class="text-gray-900 relative font-work-sans pt-20 pb-40 bg-no-repeat bg-left-bottom sm:bg-svg-bottom">

  <svg class="absolute top-0 right-0 h-full w-[375px]"  xmlns="http://www.w3.org/2000/svg" >
